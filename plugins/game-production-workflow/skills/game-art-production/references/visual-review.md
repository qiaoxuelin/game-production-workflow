...
Return read-only `Changed paths: None`, the inspected claim, evidence and coverage, fidelity limits, reviewer contribution, unresolved risks, and one recommended next delta.
